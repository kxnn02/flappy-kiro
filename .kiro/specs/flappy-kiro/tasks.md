...
- [x] 1. Set up project structure and HTML/CSS foundation
  - [x] 1.1 Create `index.html` with canvas element, steering charge progress bar, and activation button
  ...
  - [x] 1.2 Create `style.css` with dark theme, neon effects, and progress bar styling
...
- [x] 2. Implement core game engine in `app.js`
  - [x] 2.1 Implement game state machine and constants
  ...
  - [x] 2.3 Implement physics engine (gravity, terminal velocity, flap)
  ...
  - [x]* 2.4 Write property tests for physics engine
  ...
  - [x] 2.5 Implement pipe system (generation, movement, cleanup)
  ...
  - [x]* 2.6 Write property tests for pipe system
...
- [x] 3. Implement collision detection and scoring
  - [x] 3.1 Implement collision detection (AABB overlap, boundary checks)
  ...
  - [x] 3.3 Implement scoring system and high score persistence
  ...
  - [x]* 3.4 Write property tests for scoring
...
- [x] 4. Checkpoint - Core mechanics
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implement Data Packet and Steering Charge systems
  - [x] 5.1 Implement Data Packet system (spawning, movement, collection)
  ...
  - [x]* 5.2 Write property tests for Data Packet system
  ...
  - [x] 5.3 Implement Steering Charge Manager (accumulation, cap, UI update)
  ...
  - [x]* 5.4 Write property tests for Steering Charge
...
- [x] 6. Implement Steering Mode mechanics
  - [x] 6.1 Implement Steering Mode Controller (activation, timer, depletion, deactivation)
  ...
  - [x]* 6.2 Write property tests for Steering Mode depletion and activation
    - **Property 15: Steering Mode activation requires full charge**
  ...
  - [x] 6.3 Implement Autopilot behavior
...
- [x] 7. Checkpoint - Steering Mode subsystem
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement input handling, audio, and rendering
  - [x] 8.1 Implement input handler (keyboard, mouse, activation button)
...
- [x] 9. Wire everything together in the game loop
  - [x] 9.1 Implement game initialization and main game loop
  ...
  - [x]* 9.2 Write integration tests for game loop behavior
